...
// content
	...
	#sidebar-bottom {background-color:" . esc_attr($marjoram_bottom_bg) . ";color:" . esc_attr($marjoram_bottom_text) . ";}
	#sidebar-bottom li {border-color:" . esc_attr($marjoram_bottom_text) . ";}
