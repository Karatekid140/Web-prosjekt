...
function marjoram_info() {    
	...
	$config = array(
		 ...
		 */
		'upgrade'             => array(
			'upgrade_url'     => '//www.bloggingthemestyles.com/wordpress-themes/marjoram-pro',
			'price_discount'  => esc_html__( 'Get the Pro for 25% off', 'marjoram' ),
			'price_normal'	  => esc_html__( 'Save 25% off the Marjoram Pro regular price of $59. Offer EXPIRES Soon! Use the above coupon code at checkout.', 'marjoram' ),
			'coupon'	      => 'MPRO25',
			'button'	      => esc_html__( 'Get the Pro', 'marjoram' ),
		),
		...
		'getting_started' => array(
			'first' => array (
				...
				'text'                => sprintf( esc_html__( 'To help you get started with the initial setup of this theme and to learn about the various features, you can check out detailed setup documentation.', 'marjoram' ) ),
				// translators: %1$s: theme name 
				'button_label'        => sprintf( esc_html__( 'View %1$s Tutorials', 'marjoram' ), ucfirst( $theme_name ) ),
				'button_link'         => esc_url( '//www.bloggingthemestyles.com/setup-marjoram' ),
				'is_button'           => true,
		...
		'support_content'      => array(
			'first' => array (
				...
				'button_link'  => esc_url( '//wordpress.org/support/theme/marjoram' ),
				'is_button'    => true,
				'is_new_tab'   => true,
			),
			'second' => array(
